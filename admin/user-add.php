							...
							<div class="card-body">
								<div class="border p-4 rounded">
									<div class="card-title d-flex align-items-center">
										...
										<h5 class="mb-0 text-info">Tambah data pengguna</h5>
									</div>
									<hr/>
									<form action="user/add.php" method="post" enctype="multipart/form">
										<div class="row mb-3">
											<label for="inputEnterYourName" class="col-sm-3 col-form-label">Masukan nama</label>
											<div class="col-sm-9">
												<input type="text" name="name" class="form-control" id="inputEnterYourName" placeholder="Masukan nama">
											</div>
										</div>
										<div class="row mb-3">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9">
												<textarea name="address" class="form-control" id="inputAddress4" rows="3" placeholder="Masukan alamat"></textarea>
											</div>
										</div>
										<div class="row">
