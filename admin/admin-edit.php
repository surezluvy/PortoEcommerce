							...
							<div class="card-body">
								<div class="border p-4 rounded">
									<div class="card-title d-flex align-items-center">
										...
										<h5 class="mb-0 text-info">Ubah data admin</h5>
									</div>
									<hr/>
									<form action="admin/edit.php" method="post" enctype="multipart/form">
									<?php 
										include '../mysql.php';
										$data = mysqli_query($connect, "SELECT * FROM admin WHERE id='$_GET[id]'");
